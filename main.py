...
def run(fixed):
    ...
    wandb.init(project="imle", mode="online" if not args.debug else "disabled", config=args.to_dict(), name=f'{args.imle_configs.sampler}_'+hparams, entity="mls-stuttgart")
